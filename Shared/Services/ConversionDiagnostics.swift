...
/// On-device record of how someone met Streaks Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.streaks", category: "Conversion")
    ...
    private static let impressionPrefix = "streaks_"
    ...
    private static var defaults: UserDefaults {
        defaultsOverride ?? UserDefaults(suiteName: streaksAppGroupID) ?? .standard
    }
